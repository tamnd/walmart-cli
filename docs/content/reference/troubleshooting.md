...
Most of these come down to network reality or how walmart serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

walmart rate-limits like any public site. walmart already paces
...
Where a surface is gated, walmart reads a cookie or token you supply
