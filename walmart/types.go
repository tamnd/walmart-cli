...
type Product struct {
	...
	Images       []string `json:"images,omitempty"` // the photo gallery, when more than one is listed
	URL          string   `json:"url"`
}
...
type Category struct {
	...
	Trail  []string `json:"trail,omitempty"`  // the full ancestor path, root first, leaf last
	URL    string   `json:"url"`
}
