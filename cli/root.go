// Package cli assembles the walmart command tree from the walmart
...
// NewApp assembles the kit application from the walmart domain. The
...
func NewApp() *kit.App {
	id := walmart.Domain{}.Info().Identity
	id.Version = Version
